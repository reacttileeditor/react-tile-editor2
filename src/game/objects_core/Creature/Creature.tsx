...
export const New_Creature = (
	...
	return {
		...
		last_changed_hitpoints: ƒ.if(p.last_changed_hitpoints !== undefined,
			p.last_changed_hitpoints,
			-200,
		),
		hitpoint_change_tally: ƒ.if(p.hitpoint_change_tally !== undefined,
			p.hitpoint_change_tally,
			0,
		),
